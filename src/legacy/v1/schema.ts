// Frozen from v1 at 6fc8bee. Do not synchronize with mutable runtime schemas.
import { z } from "zod";
import { ARTIFACT_NAME_PATTERN, isSafeStoredArtifactPath, RUN_ID_PATTERN } from "./paths";
import {
  REVISION_STATUSES,
  RUN_STATUSES,
  STEP_STATUSES,
